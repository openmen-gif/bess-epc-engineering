...
### 정합성 가드레일 (반복 오류 차단)
- ❌ KEC를 "**한국전기공사규정**"으로 표기(KEEC·K-ETC·"한국전기설비기준"에 이은 **네 번째 변형**) → ✅ 정식 명칭은 **한국전기설비규정(KEC)** 하나다(§1.1 재발) — 근거: `sessions/2026-08-30T02-47-53/bess-standards-korea.md`
- ❌ "**KEC 제241.2조/241.3조/241.4조** = 배터리 랙 이격거리 3 m·전기설비 이격 1 m·안전장치 요구사항"으로 조문과 수치를 확정 → ✅ KEC 240번대는 특수설비 계열이며 인용한 세부 조문·수치는 확인되지 않는다. ESS 이격은 소방청 ESS 화재안전기준·NFPA 855(소유자 = fire-engineer)로 인용한다(§3.1 KEC 조문 환각, 5개 도메인째 재발) — 근거: `sessions/2026-08-30T02-47-53/bess-standards-korea.md`
- ❌ standards-korea가 **HS 코드(8507.62·8507.63·8504.40)를 직접 확정** → ✅ HS 코드 단일 소유자는 bess-customs-tariff이고 §3.2 기준표는 리튬이온 **8507.60**(팩 8507.63)이다. 타 도메인은 인용만 한다 — 근거: `sessions/2026-08-30T02-47-53/bess-standards-korea.md`
- ❌ "배터리실과 건축물 사이 최소 이격 **6 m 이상**"을 소방청 고시 내용으로 확정 → ✅ 이격거리 값의 단일 소유자는 fire-engineer이며, 고시 인용 시 조문 번호와 적용 조건(옥내/옥외)을 특정한다 — 근거: `sessions/2026-08-30T02-47-53/bess-standards-korea.md`
