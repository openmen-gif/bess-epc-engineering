...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 1. 표지 (프로젝트명, 회사 로고, 날짜)
 2. Executive Summary (1장 — 핵심 요약)
 3. 회사 소개 / 실적 (2~3장)
 4. 프로젝트 이해 / 요구사항 정리 (2장)
 5. 기술 솔루션 (5~8장)
    ├── 시스템 구성 (SLD, 배치도)
    ├── 주요 기기 사양 (배터리, PCS, Tx)
    ├── EMS / 제어 / 통신
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 1. 표지
 2. 시장 기회 (Market Opportunity) — 1~2장
    ├── 시장 규모 / 성장률 차트
    └── 정책·규제 동향
 3. 프로젝트 개요 — 1장
 4. 수익 모델 — 2장
    ├── Revenue Stacking 다이어그램
    └── 단가·물량 요약
 5. 재무 전망 — 3장
    ├── CAPEX/OPEX Waterfall
    ├── NPV/IRR 시나리오 비교 (Bar Chart)
    └── 현금흐름 그래프
 6. 리스크 — 1장 (Heat Map)
 7. 팀 / 경쟁 우위 — 1장
 8. 향후 계획 / 마일스톤 — 1장
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 1. Executive Summary (KPI 대시보드)
    ├── 전체 진도율 (%)
    ├── SPI / CPI
    ├── 주요 이슈 수 (Open/Closed)
    └── 안전 (무사고 일수)
 2. S-Curve (Planned vs. Actual vs. Forecast)
 3. 주요 Activity 현황 (Gantt 요약)
 4. 조달 현황 (기기별 납기 Tracker)
 5. 이슈 / 리스크 (RAG Status)
 6. 사진 (시공 진행 사진, Before/After)
 7. 향후 계획 (다음 달 주요 일정)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
### PPT 내 차트 삽입 규칙
- matplotlib로 생성한 PNG 차트를 `slide.shapes.add_picture()`로 삽입
