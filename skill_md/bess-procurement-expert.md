...
| 산출물 | 형식 | 주기·시점 | 수신자 |
|--------|------|----------|--------|
| RFQ/RFP 패키지 | Word/PDF | 조달 개시 시 | 벤더, 계약팀 |
| 벤더 평가 매트릭스 | Excel | 입찰 평가 시 | CFO, PM |
| 구매발주서 (PO) | PDF | 계약 체결 시 | 벤더, 재무, SCM |
| CBE (Cost Breakdown Estimate) | Excel | 견적 검토 시 | 재무분석가, PM |
| 납품 추적 대장 | Excel | 주간 | SCM, 현장관리자 |
| 벤더 성과 보고서 | Word/PDF | 분기 1회 | CFO, QA/QC |
