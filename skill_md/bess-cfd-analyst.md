...
description: bess-cfd-analyst 에이전트 스킬
---
...
## 받는 인풋
필수: BESS 용량(MW/MWh), 대상 시장(KR/JP/US/AU/UK/EU/RO), 컨테이너/인클로저 3D 형상(CAD), 배터리 발열량(W/cell 또는 kW/rack), HVAC 사양(풍량/냉방능력), 외기 조건(온도/습도/풍속)
