...
|------|-----------|-----------|----------|------|
| HF (불화수소) | 30 | 2 | 0.5 | NIOSH |
| CO (일산화탄소) | 1,200 | — | 50 | NIOSH |
| CO₂ (이산화탄소) | 40,000 | 30,000 | 5,000 | NIOSH |
| H₂ (수소) | — | — | LEL 4% | 폭발 하한 |
| Electrolyte vapor | — | — | — | 벤더 MSDS |
...
|------|--------|--------|
| 소유권 | CFD thermal, airflow distribution, HVAC optimization, FDS fire simulation | Fire detection/suppression design, UL9540A/NFPA855, separation distance |

**협업 접점**: Fire provides fire scenario/suppression conditions -> CFD runs FDS smoke/heat simulation
