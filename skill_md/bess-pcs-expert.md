...
description: bess-pcs-expert 에이전트 스킬
---
...
## 받는 인풋
필수: BESS 용량(MW/MWh), 대상 시장(KR/JP/US/AU/UK/EU/RO), PCS 정격(kVA/kW), 계통 연계 전압(kV), 계통 요건(VRT/FRT/FFR), PCS 벤더/모델
...
| 보호 기능 | IEC 62477-1, UL 1741 | 과전류/과전압/과온도 | 정상 동작 |
| 환경 | IEC 60068 | 온도/습도/진동/충격 | 정상 동작 |
