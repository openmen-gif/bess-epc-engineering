...
- 환경 모니터링 지점 설정 구체 기준: 수질은 하천 경계 50m 이내에서 pH·용존산소량·중금속 농도 측정, 대기질은 주변 주거지역·학교 인근에 PM2.5·NOx 실시간 모니터링 센서를 배치 — 근거: `sessions/2026-08-14T18-43-23/bess-env-engineer.md`
- 소음·환경 평가 축(세션 정리): 전파 예측 **ISO 9613-2** + 방음벽 삽입손실 **Maekawa 공식**, 최악조건 시나리오(전 소음원 동시 가동 · 야간 · 하향풍), 화재 시 **HF·CO** 배출 확산 예측, 유출 방지 **Bund·유수분리기**, 화재 후 토양·수질 사후 모니터링 계획 수립 — 근거: `sessions/2026-08-29T02-15-37/bess-env-engineer.md`
### 정합성 가드레일 (반복 오류 차단)
- ❌ KR 소음 기준을 "**주거지역 주간 65 dB(A) / 야간 55 dB(A)**" 단일 값으로 인용 → ✅ 소음·진동관리법 기준은 **대상(공장소음 배출허용기준 / 생활소음 규제기준 / 교통소음 한도)과 지역·시간대**별로 값이 다르다. 적용할 기준의 조항을 특정해 인용하고 특정 전에는 `[요확인]`을 유지한다 — 근거: `sessions/2026-08-29T02-15-37/bess-env-engineer.md`
- ❌ 환경엔지니어가 **배터리 셀 열유동·온도분포를 CFD로 직접 예측**하는 결론을 제시 → ✅ 시스템 내부 열유동 해석은 bess-cfd-analyst 소관이다. env-engineer가 소유하는 CFD 용도는 **대기오염물질 확산·소음 전파** 예측이며 두 용도를 구분해 표기한다(역할 경계) — 근거: `sessions/2026-08-29T02-15-37/bess-env-engineer.md`
- ❌ 리스크 등급을 한자 **中/高**로 표기 → ✅ 한국어(높음/중간/낮음) 또는 Critical·High·Medium·Low(§4 재발) — 근거: `sessions/2026-08-29T02-15-37/bess-env-engineer.md`
- ❌ **KR 부지 환경검토에 미국 기준을 국내 준수 근거로 인용**("US EPA 40 CFR 112(SPCC)에 따라 유류 유출 방지 시스템 구축", "ASTM E1527-21에 따라 Phase I/II 조사 수행") → ✅ KR은 **토양환경보전법**(오염도 조사·정화), **위험물안전관리법**(유류 저장·방유제), **물환경보전법**(폐수·비점오염)이 근거다. 미국 기준을 병기할 때는 "(참고용, 국내 적용 아님)"을 명시(가드레일 §1.1 시장 교차오염) — 근거: `sessions/2026-08-20T00-30-41/bess-env-engineer.md`
- ❌ 법령명을 "**생물다양성 보전법**"으로 축약 표기 → ✅ 정식 제명은 **「생물다양성 보전 및 이용에 관한 법률」**(약칭 생물다양성법)이다. 법령은 약칭 규정에 있는 명칭이나 정식 제명으로만 인용 — 근거: `sessions/2026-08-20T00-30-41/bess-env-engineer.md`
- ❌ 공사장 소음 규제기준을 "**소음·진동관리법 시행규칙 별표5**"로 조문까지 특정 → ✅ 시행규칙 별표 번호는 개정으로 변동되므로, 확인 전에는 **「소음·진동관리법 시행규칙」 생활소음·진동 규제기준**으로 표기하고 별표 번호에는 `[요확인]`을 단다 — 근거: `sessions/2026-08-20T00-30-41/bess-env-engineer.md`
- ❌ 뉴스 1건의 신기술(코스모스랩 '물 배터리')을 EIA 화재위험 저감 근거로 편입 → ✅ 화재위험 판정은 UL 9540A·NFPA 855 시험·설계값(fire-engineer 소관)으로만 하고, 뉴스는 `[요확인]` 유지(가드레일 §0-7) — 근거: `sessions/2026-08-20T00-30-41/bess-env-engineer.md`
