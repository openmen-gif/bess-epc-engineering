...
| Pier / Pedestal (독립기초) | 지내력 ≥150 kPa, 경량 장비 | 최소 토공, 빠른 시공 | 지내력 높아야 함 |
| Pile Foundation (말뚝) | 연약 지반, 지내력 부족 | 깊은 지지층 활용 | 고비용, 공기 길어짐 |
| Screw Pile (나선말뚝) | 지내력 80~200 kPa | 무소음, 빠른 시공, 재사용 | 암반 시 부적합 |
...
|------|--------|--------|
| 소유권 | Site grading, foundation design, HVAC, fire piping, drainage, container layout | FEM, seismic, wind load, buckling, DCR verification |

**협업 접점**: C-BOP provides foundation type/loads -> Structural verifies via FEM, returns DCR
